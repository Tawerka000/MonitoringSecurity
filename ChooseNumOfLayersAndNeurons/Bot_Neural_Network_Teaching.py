...
neural_network_name = 'Bot'

dataset_for_teach_path = 'D:\\Python\MonitoringSecurityProject\\Datasets\\NewDataSets\\BotnewDataset.csv'
...
#selected_features.to_csv('file_name.csv', index=False)  # сохранение в CSV без индексов
